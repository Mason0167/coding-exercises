...
describe('_surplus()', () =>  {
    it('this function returns a function (inner in this case) that returns the source string ',  () => {
...
describe('_strNumbers()', () =>  {
    it('this returns new array, that has numbers in them',  () => {
...
describe('_moveCapitalLetters()', () =>  {
    it('this function moves all the capital letters to the front and all the lower case letter to the back',  () => {
